Feature: US1007_kullanici_data_ekleyebilmeli
  ...
  Scenario Outline:TC09_5_farkli_kisi_ile_farkli_kombinasyonlari_calismali
    When kullanici "datatable_url" anasayfa gider
    ...
    Examples:
      | firstname | lastname | position     | office  | extencion | date | salary |
      | mehmet    | bulut    | teacher      | ankara  |---        | 2020-12-10|100|
